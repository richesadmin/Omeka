    ...
    <footer class="container" role="contentinfo">
        <div class="ten columns offset-by-two">
            ...
            <p class="left">
                <a href="https://omeka.org" target="_blank" rel="noreferrer"><?php echo __('Powered by Omeka') ?></a>
                <a href="https://omeka.org/classic/docs/" target="_blank" rel="noreferrer"><?php echo __('Documentation'); ?></a>
                <a href="https://forum.omeka.org" target="_blank" rel="noreferrer"><?php echo __('Support Forums'); ?></a>
