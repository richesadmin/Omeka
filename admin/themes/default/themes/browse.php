...
<div id="current-theme" class="theme">
    ...
    <div id="current-info" class="six columns omega">
        ...
        <p class="theme-support-link"><a href="<?php echo $current->support_link; ?>" target="_blank" rel="noreferrer"><?php echo __('Get support');?></a></p>
...
<p class="managethemes"><?php echo __('Add new themes by downloading them from the <a href="http://omeka.org/add-ons/themes/" target="_blank" rel="noreferrer">Omeka Theme Directory</a>, or <a href="http://omeka.org/codex/Theme_Writing_Best_Practices" target="_blank" rel="noreferrer">design your own</a>!'); ?></p>
<div class="themes group">
    <form autocomplete="off" method="post" id="themes-form" action="<?php echo $this->url(['controller' => 'themes', 'action' => 'switch'], 'default'); ?>">
<?php
$i = 1;
...
?>
        <div class="theme three columns<?php if ($i % 3 == 1) echo ' alpha'; $i++; ?>">
            ...
            <div class="meta">
                ...
                <p class="author"><a href="<?php echo html_escape($theme->website); ?>" target="_blank" rel="noreferrer"><?php echo __('By %s', html_escape($theme->author)); ?></a></p>
                <p class="theme-support-link"><a href="<?php echo $theme->support_link; ?>" target="_blank" rel="noreferrer"><?php echo __('Get support');?></a></p>
            </div>
